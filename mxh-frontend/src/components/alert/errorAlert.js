  ...
  return (
    <>
      ...
      <div className="fixed z-50  transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
        <div
          className="p-2 border-2  border-red-700 border-opacity-50 rounded-md"
          style={{ backgroundColor: "white" }}
        >
          <Alert severity="error" className={classes.myStyle}>
            <p className=" font-semibold text-md">{err}</p>
          </Alert>
        </div>
      </div>
    </>
