...
var useScreenRecorder = function (_a) {
  ...
  var _f = useState(),
    mediaRecorder = _f[0],
    setMediaRecorder = _f[1];
  var _g = useState("permission-requested"),
    status = _g[0],
    setStatus = _g[1];
  var _h = useState({ audio: null, screen: null }),
    streams = _h[0],
    setStreams = _h[1];
  useEffect(
    function () {
      ...
      mediaRecorder.ondataavailable = function (event) {
        ...
        var blobs = event.data.slice(0, event.data.size, "video/mp4");
        setBlobUrl(url);
        setBlob(blobs);
      };
    },
        ...
        switch (_a.label) {
          ...
          case 3:
            tracks = __spreadArrays(
              displayMedia === null || displayMedia === void 0
                ? void 0
                : displayMedia.getTracks(),
              userMedia === null || userMedia === void 0
                ? void 0
                : userMedia.getTracks()
            );
            ...
            setStreams({
              audio:
                ...
                (userMedia === null || userMedia === void 0
                  ? void 0
                  : userMedia.getTracks().find(function (track) {
                      return track.kind === "audio";
                    })) || null,
              screen:
                displayMedia.getTracks().find(function (track) {
  ...
  var stopRecording = function () {
    ...
    mediaRecorder === null || mediaRecorder === void 0
      ? void 0
      : mediaRecorder.stop();
    setStatus("stopped");
