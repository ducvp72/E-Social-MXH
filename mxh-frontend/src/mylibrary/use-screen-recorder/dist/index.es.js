...
var useScreenRecorder = function (_a) {
    ...
    var _c = useState(null), blobUrl = _c[0], setBlobUrl = _c[1];
    var _d = useState(null), blob = _d[0], setBlob = _d[1];
    var _e = useState(), error = _e[0], setError = _e[1];
    var _f = useState(), mediaRecorder = _f[0], setMediaRecorder = _f[1];
    var _g = useState("permission-requested"), status = _g[0], setStatus = _g[1];
    var _h = useState({ audio: null, screen: null }), streams = _h[0], setStreams = _h[1];
    useEffect(function () {
        if (!mediaRecorder)
            return;
