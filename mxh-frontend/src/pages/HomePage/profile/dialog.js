  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <div className="w-64 divide-y divide-gray-300">
        ...
        <div onClick={onClose} className="  cursor-pointer py-2 px-4 bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-red-500 hover:text-white text-gray-700 text-lg font-medium text-center">
          Hủy
        </div>
      </div>
    </Dialog>
